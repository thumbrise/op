      ...
      '/universal/': [
        {
          ...
          items: [
            ...
            {text: '#1 — Eyeballs', link: '/universal/001-curl-eyeballs'},
            {text: '#2 — Gallium', link: '/universal/002-spiral'},
            {text: '#3 — Bleed', link: '/universal/003-roadrunner-bleeds-across-layers'},
            {text: '#4 — Struggle', link: '/universal/004-php-poc-struggle'},
            {text: '#5 — Truth', link: '/universal/005-single-source-of-truth'},
            {text: '#6 — Forgotten', link: '/universal/006-what-programs-forgot'},
            {text: '#7 — Linus', link: '/universal/007-why-we-dont-call-linus'},
            {text: '#8 — Configuration', link: '/universal/008-configuration-is-not-parameterization'},
            {text: '#9 — Address', link: '/universal/009-the-address-is-a-detail'},
            {text: '#10 — Pistol', link: '/universal/010-fifty-triggers-fifty-barrels'},
            {text: '#11 — Bundle', link: '/universal/011-postgres-is-a-bundle'},
            {text: '#12 — Profession', link: '/universal/012-the-disappearing-profession'},
            {text: '#13 — Lock', link: '/universal/013-the-lock-that-disappeared'},
            {text: '#14 — Markets', link: '/universal/014-two-invisible-markets'},
            {text: '#15 — Black', link: '/universal/015-the-black-compiler'},
            {text: '#16 — Migrations', link: '/universal/016-the-origin-of-migrations'},
            {text: '#17 — JIT', link: '/universal/017-postgres-is-a-jit'},
            {text: '#18 — Guards', link: '/universal/018-hand-written-deopt-guards'},
            {text: '#19 — MongoDB', link: '/universal/019-nobody-chooses-mongodb'},
            {text: '#20 — Promise', link: '/universal/020-how-much-you-promise'},
            {text: '#21 — Equality', link: '/universal/021-all-programs-are-equal'},
            {text: '#22 — Nothing', link: '/universal/022-why-nothing-lands'},
            {text: '#23 — Treaty', link: '/universal/023-treaty-of-five'},
          ],
        },
      ],
      '/dreams/': [
        {
          ...
          items: [
            ...
            {text: 'The dial', link: '/dreams/005-the-dial'},
            {text: 'The four letters', link: '/dreams/006-the-four-letters'},
            {text: 'Lesson 2 — The book on the desk', link: '/dreams/007-the-book-on-the-desk'},
            {text: 'The harbourmaster', link: '/dreams/008-the-harbourmaster'},
            {text: 'The dance', link: '/dreams/009-the-dance'},
            ...
            {text: 'Epilogue', link: '/dreams/014-epilogue'},
          ],
        },
      ],
      '/reference/': [
