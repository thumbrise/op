      ...
      '/universal/': [
        {
          ...
          items: [
            ...
            {text: '#10 — Fifty Triggers, Fifty Barrels', link: '/universal/010-fifty-triggers-fifty-barrels'},
            {text: '#11 — Postgres Is a Bundle', link: '/universal/011-postgres-is-a-bundle'},
            {text: '#12 — The Disappearing Profession', link: '/universal/012-the-disappearing-profession'},
            {text: '#13 — The Lock That Disappeared', link: '/universal/013-the-lock-that-disappeared'},
