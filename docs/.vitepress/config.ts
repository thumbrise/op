    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {text: 'Form Of Rail', link: '/notes/form-of-rail/'},
          {text: 'Form Of Instruction', link: '/notes/form-of-instruction/'},
          {text: 'Form Of Nota', link: '/notes/form-of-nota/'},
      ...
      },
      {
        text: 'Books',
        items: [
          {text: "Dream", link: '/books/dream/'},
        ],
      },
      {
        text: 'Reference',
        items: [
          {text: 'About', link: '/reference/'},
          {text: 'rfc-operation-protocol.md', link: '/reference/rfc-operation-protocol.md'},
          {
            text: 'rfc-operation-protocol-appendix-a-raw.md',
            link: '/reference/rfc-operation-protocol-appendix-a-raw.md'
          },
          {text: 'the-primitive-range-conjecture.md', link: '/reference/the-primitive-range-conjecture.md'},
          {text: 'operation.v1.json', link: '/op/reference/operation.v1.json'},
          {text: 'nota.v1.json', link: '/op/reference/nota.v1.json'},
          {text: 'rail.v1.json', link: '/op/reference/rail.v1.json'},
          {text: 'instruction.v1.json', link: '/op/reference/instruction.v1.json'},
        ],
      },
      ...
      '/notes/form-of-instruction/': [
        {
          ...
          items: [
            ...
            {text: 'The Codex', link: '/notes/form-of-instruction/001-the-codex/'},
          ],
        },
      ],
      '/notes/form-of-nota/': [
        {
          text: 'Form Of Nota',
          items: [
            {text: 'About', link: '/notes/form-of-nota/'},
            {text: 'The Observation', link: '/notes/form-of-nota/001-the-observation/'},
          ],
        },
      ],
      '/notes/form-of-rail/': [
      ...
      '/books/dream/': [
        {
          text: "Dream",
          items: [
            {text: 'Opening', link: '/books/dream/'},
            {text: 'Lesson 1 — What an operation is', link: '/books/dream/001-what-is-an-operation'},
            {text: 'The handshake', link: '/books/dream/002-the-handshake'},
            {text: 'The understory', link: '/books/dream/003-the-understory'},
            {text: 'The mound', link: '/books/dream/004-the-mound'},
            {text: 'The dial', link: '/books/dream/005-the-dial'},
            {text: 'The four letters', link: '/books/dream/006-the-four-letters'},
            {text: 'Lesson 2 — The book on the desk', link: '/books/dream/007-the-book-on-the-desk'},
            {text: 'The harbourmaster', link: '/books/dream/008-the-harbourmaster'},
            {text: 'The dance', link: '/books/dream/009-the-dance'},
            {text: 'The murmuration', link: '/books/dream/010-the-murmuration'},
            {text: 'The black square', link: '/books/dream/011-the-black-square'},
            {text: 'Lesson 3 — The cover', link: '/books/dream/012-the-cover'},
            {text: 'The dream fulfilled', link: '/books/dream/013-the-dream-fulfilled'},
            {text: 'Epilogue', link: '/books/dream/014-epilogue'},
          ],
        },
      ],
      '/reference/': [
        {
          ...
          items: [
            {text: 'About', link: '/reference/'},
            {text: 'rfc-operation-protocol.md', link: '/reference/rfc-operation-protocol.md'},
            {text: 'rfc-operation-protocol-appendix-a-raw.md', link: '/reference/rfc-operation-protocol-appendix-a-raw.md'},
            {text: 'the-primitive-range-conjecture.md', link: '/reference/the-primitive-range-conjecture.md'},
            {text: 'operation.v1.json', link: '/op/reference/operation.v1.json'},
            {text: 'nota.v1.json', link: '/op/reference/nota.v1.json'},
            {text: 'rail.v1.json', link: '/op/reference/rail.v1.json'},
