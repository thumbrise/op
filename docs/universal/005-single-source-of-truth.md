#34-5 — Universal — Single Source of Truth in Infra
...
This is the same leak as #34-3 but on a different axis. Tools designed in isolation each invent their own opinion about config. None of them assumes another tool will read the same value. So everyone duplicates.
