...
> **Schema state — landed.** The two additions described in this devlog — `term.comment` and `term.required` — are reflected in the current reference schemas: [`docs/reference/operation.v1.json`](../../reference/operation.v1.json) · [`docs/reference/instruction.v1.json`](../../reference/instruction.v1.json).
