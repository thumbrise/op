---
title: Form Of Operation - Notes
description: "A public research journal about form of operation. We observe, hypothesize, test, and record - in the order it happens."
---

# Form Of Operation - Notes
...
If we cannot find a counterexample to a statement, we record it as a fact. Not as truth — as a fact that has survived every test we could throw at it. If you find a counterexample, [open an issue](https://github.com/thumbrise/op/issues). We will update the journal. That is how science works.
