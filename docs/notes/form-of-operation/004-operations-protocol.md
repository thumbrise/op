...
> **Schema state — landed.** The canonical, machine-readable definition of an instruction is [`docs/reference/instruction.v1.json`](../../reference/instruction.v1.json). Individual operation shape: [`docs/reference/operation.v1.json`](../../reference/operation.v1.json). Both schemas are the source of truth. The prose below describes the conceptual framing; the schemas are what tool authors should code against.
...
This is a snapshot of work in progress. The final specification is defined in [rfc-operation-protocol.md](../../reference/rfc-operation-protocol.md).
